          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h2 className="text-xl font-semibold text-[#7F5539] mb-3">Client Details</h2>
                <div className="flex gap-4">
                  <select
                    className="w-24 px-4 py-3 bg-white/50 border border-[#B08968]/20 rounded-lg text-[#7F5539] focus:outline-none focus:ring-2 focus:ring-[#B08968] focus:border-transparent transition-all duration-300"
                  ...
                  <input
                    ...
                    className="flex-1 px-4 py-3 bg-white/50 border border-[#B08968]/20 rounded-lg text-[#7F5539] placeholder-[#9C6644] focus:outline-none focus:ring-2 focus:ring-[#B08968] focus:border-transparent transition-all duration-300"
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <h2 className="text-xl font-semibold text-[#7F5539]">Terms and Conditions</h2>
                <button
                  type="button"
                  onClick={() => setFormData({
                    ...formData,
